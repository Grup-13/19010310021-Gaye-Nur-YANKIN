...
{  
   ...
   private static final int Server_PORT = 50; 
   private static final int Client_PORT = 55;
   ...
   {  
      ...
      {  
          try  
          {  
        	  System.out.println("TCPRoute5 Başlatılıyor..\\n Localhost'un ip Adresi Alınıyor..");
